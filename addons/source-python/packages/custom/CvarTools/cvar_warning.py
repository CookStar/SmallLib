...
class CvarWarning(CvarChecker):
    ...
    @staticmethod
    def warn(index, cvar_name, cvar_value, event_name):
        cvar_warning = CvarWarning._warnings[cvar_name]
        cvar_warning.add(index)

        events = CvarWarning._events[event_name]
        events[index] -= 1
                ...
                if cvar_warning.kick:
                    ...
                    if remain == 0:
                        ...
                        if remains:
                            ...
                            remains = remain
                    warned[index] += 1
                cvars += cvar_warning.cvar_name + " " + str(cvar_warning.cvar_value) + ";"
    ...
    def _unload_instance(self):
        del self._warnings[self.cvar_name]
